...
function Gallery({ isActive }) {
  ...
  const photos = [
    { src: "public/images/pic1.jpg", alt: "Memory 1" },
    { src: "public/images/pic2.jpg", alt: "Memory 2" },
    { src: "public/images/pic3.jpg", alt: "Memory 3" },
    { src: "public/images/pic4.jpg", alt: "Memory 4" },
    { src: "public/images/pic5.jpg", alt: "Memory 5" },
    { src: "public/images/pic6.JPG", alt: "Memory 6" },
  ];
