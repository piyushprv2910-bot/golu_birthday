    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Guggie</span> 🎂
              </>
            ) : (
              <>
          ...
          <p>Your The Best Thing Ever Happend To Me,
              ILOVEYOUTHEMOST
             💗</p>
        </section>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Yours — MY LOVE 💖</h2>
          <p className="final-subtitle">YOURS ALWAYS&FOREVER 💖✨</p>
        </section>
      </div>
